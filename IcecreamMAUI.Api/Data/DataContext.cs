    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<IcecreamOption>()
                .HasKey(i => new { i.IcecreamId, i.Topping, i.Flavor });
        ...
        {
            Icecream[] icecreams = [
                new Icecream { Id = 1, Name = "Vanilla Delight", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_0.jpg", Price = 6.25, },
                new Icecream { Id = 2, Name = "ChocoBerry Bliss", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_1.jpg", Price = 7.5, },
                new Icecream { Id = 3, Name = "Minty Cookie Crunch", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_2.jpg", Price = 8.75, },
                new Icecream { Id = 4, Name = "Strawberry Dream", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_3.jpg", Price = 6.95, },
                new Icecream { Id = 5, Name = "Cookie Dough Extravaganza", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_4.jpg", Price = 9.2, },
                new Icecream { Id = 6, Name = "Caramel Swirl Symphony", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_5.jpg", Price = 7.75, },
                new Icecream { Id = 7, Name = "Peanut Butter Paradise", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_6.jpg", Price = 8.5, },
                new Icecream { Id = 8, Name = "Mango Tango Tango", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_7.jpg", Price = 9.8, },
                new Icecream { Id = 9, Name = "Hazelnut Heaven", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_8.jpg", Price = 8.95, },
                new Icecream { Id = 10, Name = "Blueberry Bliss Bonanza", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_9.jpg", Price = 7.2, },
                new Icecream { Id = 11, Name = "Toffee Twist Temptation", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_10.jpg", Price = 7.95, },
                new Icecream { Id = 12, Name = "Rocky Road Revelry", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_11.jpg", Price = 9.5, },
                new Icecream { Id = 13, Name = "Passionfruit Paradise", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_12.jpg", Price = 8.75, },
                new Icecream { Id = 14, Name = "Cotton Candy Carnival", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_13.jpg", Price = 7.2, },
                new Icecream { Id = 15, Name = "Lemon Sorbet Serenity", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_14.jpg", Price = 6.9, },
                new Icecream { Id = 16, Name = "Maple Pecan Pleasure", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_15.jpg", Price = 8.25, },
                new Icecream { Id = 17, Name = "Raspberry Ripple Rhapsody", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_16.jpg", Price = 7.45, },
                new Icecream { Id = 18, Name = "Almond Joyful Jubilee", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_17.jpg", Price = 9.95, },
                new Icecream { Id = 19, Name = "Blue Lagoon Bliss", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_18.jpg", Price = 8.5, },
                new Icecream { Id = 20, Name = "Coconut Caramel Carnival", Image = "https://github.com/Arunachalam13/Images-Icons-Repo/blob/AddIcecream/low-qty/ic_19.jpg", Price = 7.8, },
            ...
            IcecreamOption[] icecreamOptions = [
                ...
                new IcecreamOption { IcecreamId = 12, Flavor = "Mini Chocolate", Topping = "Default" },
                ...
                new IcecreamOption { IcecreamId = 17, Flavor = "Strawbeery", Topping = "Default" },
                ...
                new IcecreamOption { IcecreamId = 20, Flavor = "Mint Choclate Chip", Topping = "Default" },
            ...
            modelBuilder.Entity<IcecreamOption>().HasData(icecreamOptions);
        }
    }
}
